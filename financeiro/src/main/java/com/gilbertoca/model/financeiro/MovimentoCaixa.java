...
public class MovimentoCaixa extends BaseObject implements Serializable {
    ...
    /**
     * Usado para determinar se um caixa j� foi processado. Um movimento de caxia,
     * so poder�o ser processado se estiver aberto, ou seja, o atributo flFechado
     * for igual a false.
	 * @return boolean
     */
    ...
    /**
     * Se o Movimento de Caixa est� fechado(true) ou aberto(false).
     * @return boolean 
     */
    ...
    public Double getSaldoInternal(){
        ...
        while (i.hasNext()) {
            ...
            //Verificamos se o item n�o foi cancelado
   ...
   /**
    * Totaliza as sa�das do movimento de Caixa. Realiza um loop sobre todos os itens
    * do movimento e, para cada item chama movimentoCaixaLancamento.getValor() 
    * para debito.
    * @return Double 
    */
