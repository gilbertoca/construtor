 ...
 * @author gilberto
 */
public class ViewEmployee extends BorderPage {

    private static final long serialVersionUID = 1L;
    protected Form form = new Form("form");
    protected Table table = new Table("table");
    protected PageLink editLink = new PageLink("editLink", EditEmployee.class);
    ...
    public ViewEmployee() {
        ...
        getModel().put("title", getMessage("viewEmployee.title"));
        getModel().put("heading", getMessage("viewEmployee.heading"));
        ...
        Column column = new Column("naturalPerson.name");
        table.addColumn(column);
        column = new Column("parking.address");
        table.addColumn(column);
        column = new Column("dtAdmission");
        ...
        table.setDataProvider(new DataProvider<Employee>() {

            public List<Employee> getData() {
                return (List<Employee>) findByName();
            }
        });
    }
    ...
    private List findByName() {
        System.out.println("\n findByName() method \n");
        Query queryObject = em.createNamedQuery("Employee.findByName");
