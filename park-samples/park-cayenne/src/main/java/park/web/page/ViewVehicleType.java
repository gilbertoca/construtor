...
public class ViewVehicleType extends BorderPage {
    ...
    private List findByVehicleType() {
        ...
        params.put("vehicleType",  "%" + vehicleTypeField.getValue() + "%");
        NamedQuery queryObject = new NamedQuery("VehicleType.findByVehicleType", params);
        return context.performQuery(queryObject);
    }
