...
public class EditVehicle extends BorderPage {
    ...
    public EditVehicle() {
        ...
        vehicleTypeSelect.setDataProvider(new DataProvider() {
            ...
            public List getData() {
                ...
                List<VehicleType> vehicleTypes = getAll(VehicleType.class);
        ...
        priceTableSelect.setDataProvider(new DataProvider() {
            ...
            public List getData() {
                ...
                List<PriceTable> priceTables = getAll(PriceTable.class);
        ...
        customerSelect.setDataProvider(new DataProvider() {
            ...
            public List getData() {
                ...
                for (Customer customer : customers) {
                    options.add(new Option(customer.getObjectId(), customer.getPerson().getName()));
                }
                return options;
            }
        });
    ...
    private List getAll(Class classEntity) {
        System.out.println("\n getAll() method \n");
        SelectQuery query = new SelectQuery(classEntity);
    ...
    public void onGet() {
        ...
        if (id != null) {
            ...
            Vehicle vehicle = Cayenne.objectForPK(context,Vehicle.class, id);
            if (vehicle != null) {
    ...
    public boolean onOkClick() throws Exception {
        ...
        if (form.isValid()) {
            ...
            if (_isNew) {
                ...
                vehicle = Cayenne.objectForPK(context,Vehicle.class, _id);
            }
