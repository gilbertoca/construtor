...
--PERSON TABLE;
INSERT INTO PERSON (ID, ADDRESS, NAME, DISCRIMINATOR) VALUES(1,'ADDRESS1','LEGAL_ENTITY','LE');
INSERT INTO PERSON (ID, ADDRESS, NAME, DISCRIMINATOR) VALUES(2,'ADDRESS2','NATURAL_PERSON','NP');
--LEGAL_ENTITY TABLE
...
--CUSTOMER TABLE
INSERT INTO CUSTOMER (PERSON_ID, PAYMENT_DAY) VALUES(1, 12);
...
--PRICE_TABLE
INSERT INTO VEHICLE(CUSTOMER_ID, PRICE_TABLE_ID, COLOR, LICENSE_PLATE,V_TYPE) VALUES(1, 1, 'COR1', 'PLACA1','CARRO');
INSERT INTO VEHICLE(CUSTOMER_ID, PRICE_TABLE_ID, COLOR, LICENSE_PLATE,V_TYPE) VALUES(2, 1, 'COR2', 'PLACA2','CARRO');
