...
To adjust the database parameters edit the following shiro/pom.xml properties(the actual value is mine) if you want to change the H2 server type:
...
To change the way the jpa engine drop/create the database object you need to edit the following cip/shiro/pom.xml properties(the actual value is mine):
...
Now you can test (into cip/shiro):
