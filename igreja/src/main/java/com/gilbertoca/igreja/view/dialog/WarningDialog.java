...
public class WarningDialog extends javax.swing.JDialog {
    ...
    public static void show(String mensaje) {
        WarningDialog dialog = new WarningDialog(BaseApp.getApplication().getMainFrame(), mensaje);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(base.view.BaseApp.class).getContext().getResourceMap(WarningDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(base.view.BaseApp.class).getContext().getActionMap(WarningDialog.class, this);
