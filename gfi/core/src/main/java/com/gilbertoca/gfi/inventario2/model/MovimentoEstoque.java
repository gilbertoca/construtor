...
public class MovimentoEstoque implements Serializable{
    ...
    /**
     * C�digo da Venda no movimento do estoque. 
     * Desta forma pela venda saberemos o nome/Raz�oSocial e o cpf/cnpj do cliente.
     */    
...
//     * @hibernate.many-to-one
//     *  insert="false" update="false" column="loc_nu_sequencial"
//     *  outer-join="true"
//     * @return a populated localidade object (based on the loc_nu_sequencial)
//     */    
...
//    }
//    /**
//     * @return Returns the tipoLogr.
//     * @hibernate.many-to-one
//     *  insert="false" update="false" column="tipo_logradouro"
//     *  outer-join="true"
//     * @return a populated tipoLogr object (based on the tipo_logradouro)
//     */    
//    public TipoLogr getTipoLogr() {
//        return tipoLogr;
//    }
//    /**
//     * @param tipoLogr The tipoLogr to set.
//     */
//    public void setTipoLogr(TipoLogr tipoLogr) {
